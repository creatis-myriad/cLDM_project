...
def main(cfg) :
    ...
    log.info("Training ...")
    trainer.fit(cLDM_concat_model, Datamodule_)
    ...
    for data in Datamodule_.test_dataloader():
        ...
        decoded_img = cLDM_concat_model.generate(conditioning, shape_data)
        decoded_img = format.torch_to_numpy(decoded_img)

        decoded_cond = mod_seg.decode(conditioning / cfg.model.net.scale_factor)
